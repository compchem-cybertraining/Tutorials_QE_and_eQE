...
def plot(_energy, _pdosa, _pdosb):
    ...
    plt.plot(_energy[:,0], _pdosa[:, 0], label='Cs', linewidth=lw, color = colors["11"]) 
    plt.plot(_energy[:,0], _pdosa[:, 1], label='Sn', linewidth=lw, color = colors["21"]) 
    plt.plot(_energy[:,0], _pdosa[:, 2], label='Br', linewidth=lw, color = colors["31"]) 
